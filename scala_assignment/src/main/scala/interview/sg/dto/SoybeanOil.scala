...
class SoybeanOil {
  ...
  var cropYear: String = ""
  var crush: String = ""
  var extractionRate: String = ""
  var production: String = ""
  var imports: String = ""
  var exports: String = ""
  var totalConsumption: String = ""
  var foodUse: String = ""
  var industryFeedUse: String = ""
  ...
  def setExtractionRate(er: String): Unit = {
    extractionRate = er
  }

  def getExtractionRate(): String = {
    extractionRate
  }
  ...
  def setFoodUse(fu: String): Unit = {
    foodUse = fu
  }

  def getFoodUse(): String = {
    foodUse
  }

  def setIndustryFeedUse(ifu: String): Unit = {
    industryFeedUse = ifu
  }

  def getIndustryFeedUse(): String = {
    industryFeedUse
  }
