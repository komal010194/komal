...
class Sorghum {
    ...
    var foodSeedIndustrialUse: String = ""
    var feedUse: String = ""
    ...
    def setFoodSeedIndustrialUse(fsi: String): Unit ={
      foodSeedIndustrialUse = fsi
    }
    def getFoodSeedIndustrialUse(): String = {
      foodSeedIndustrialUse
    }

    def setFeedUse(fu: String): Unit = {
      feedUse = fu
    }
    def getFeedUse(): String ={
      feedUse
    }
